  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(h1, file, 39, 2, 836);
  			add_location(p, file, 43, 2, 963);
  			attr_dev(input, "type", "text");
  			attr_dev(input, "class", "svelte-s1wugr");
  			add_location(input, file, 44, 2, 989);
  			add_location(button, file, 45, 2, 1035);
  			attr_dev(dialog, "id", "modal");
  			attr_dev(dialog, "class", "js-modal c-modal svelte-s1wugr");
  			toggle_class(dialog, "js-active", /*check*/ ctx[0]);
  			add_location(dialog, file, 38, 1, 714);
  		},
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(label, file, 41, 3, 878);
  			attr_dev(input, "type", "");
  			attr_dev(input, "name", "");
  			add_location(input, file, 41, 29, 904);
  		},
  		m: function mount(target, anchor) {
