  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(h1, file, 40, 2, 867);
  			add_location(p, file, 44, 2, 994);
  			attr_dev(input, "type", "text");
  			attr_dev(input, "class", "svelte-s1wugr");
  			add_location(input, file, 45, 2, 1020);
  			add_location(button, file, 46, 2, 1066);
  			attr_dev(dialog, "id", "modal");
  			attr_dev(dialog, "class", "js-modal c-modal svelte-s1wugr");
  			toggle_class(dialog, "js-active", /*check*/ ctx[0]);
  			add_location(dialog, file, 39, 1, 745);
  		},
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(label, file, 42, 3, 909);
  			attr_dev(input, "type", "");
  			attr_dev(input, "name", "");
  			add_location(input, file, 42, 29, 935);
  		},
  		m: function mount(target, anchor) {
