...
(function () {
  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(h1, file, 22, 3, 633);
  			add_location(p, file, 23, 3, 653);
  			attr_dev(input, "type", "text");
  			attr_dev(input, "class", "svelte-19v79af");
  			add_location(input, file, 24, 3, 680);
  			add_location(button, file, 25, 3, 704);
  			attr_dev(dialog, "id", "modal");
  			attr_dev(dialog, "class", "js-modal c-modal svelte-19v79af");
  			toggle_class(dialog, "js-active", /*check*/ ctx[0]);
  			add_location(dialog, file, 21, 2, 510);
  		},
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	$$self.$capture_state = () => ({ slide, fade, check });
